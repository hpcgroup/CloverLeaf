...
#pragma omp target teams map(alloc: xarea[:field.xarea.N()],yarea[:field.yarea.N()],volume[:field.volume.N()],density0[:field.density0.N()],pressure[:field.pressure.N()],viscosity[:field.viscosity.N()],xvel0[:field.xvel0.N()],xvel1[:field.xvel1.N()],yvel0[:field.yvel0.N()],yvel1[:field.yvel1.N()]) firstprivate(y_min,y_max,x_min,x_max,halfdt,base_stride,vels_wk_stride,xarea_sizex,yarea_sizex)
