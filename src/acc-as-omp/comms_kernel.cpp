...
#pragma omp target enter data map(alloc: left_rcv[:left_rcv_buffer.N()]) map(alloc: left_snd[:left_snd_buffer.N()]) map(alloc: right_rcv[:right_rcv_buffer.N()]) map(alloc: right_snd[:right_snd_buffer.N()]) map(alloc: top_rcv[:top_rcv_buffer.N()]) map(alloc: top_snd[:top_snd_buffer.N()]) map(alloc: bottom_rcv[:bottom_rcv_buffer.N()]) map(alloc: bottom_snd[:bottom_snd_buffer.N()])
...
#pragma omp target exit data map(release: left_rcv,left_snd,right_rcv,right_snd,top_rcv,top_snd,bottom_rcv,bottom_snd)
}
