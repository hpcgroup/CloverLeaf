...
#pragma omp target enter data map(to: vol,mass,ie,ke,press)
...
#pragma omp target teams map(alloc: vol,mass,ie,ke,press) map(alloc: volume[:field.volume.N()],density0[:field.density0.N()],energy0[:field.energy0.N()],pressure[:field.pressure.N()],xvel0[:field.xvel0.N()],yvel0[:field.yvel0.N()]) firstprivate(ymax,ymin,xmax,xmin,vels_wk_stride,base_stride) reduction(+: vol) reduction(+: mass) reduction(+: ie) reduction(+: ke) reduction(+: press)
#pragma omp distribute parallel for simd reduction(+: vol,mass,ie,ke,press)
...
#pragma omp target exit data map(from: vol,mass,ie,ke,press)
