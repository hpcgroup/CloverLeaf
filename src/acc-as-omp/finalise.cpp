...
#pragma omp target exit data map(release: density0,density1,energy0,energy1,pressure,viscosity,soundspeed,yvel0,yvel1,xvel0,xvel1,vol_flux_x,vol_flux_y,mass_flux_x,mass_flux_y,work_array1,work_array2,work_array3,work_array4,work_array5,work_array6,work_array7,cellx,celldx,celly,celldy,vertexx,vertexdx,vertexy,vertexdy,volume,xarea,yarea)
  }
}
