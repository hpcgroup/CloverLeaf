...
#pragma omp target teams map(alloc: xarea[:field.xarea.N()],yarea[:field.yarea.N()],xvel0[:field.xvel0.N()],xvel1[:field.xvel1.N()],yvel0[:field.yvel0.N()],yvel1[:field.yvel1.N()],vol_flux_x[:field.vol_flux_x.N()],vol_flux_y[:field.vol_flux_y.N()]) firstprivate(y_min,y_max,x_min,x_max,flux_x_stride,dt,vels_wk_stride,flux_y_stride)
