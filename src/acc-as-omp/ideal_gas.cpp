...
#pragma omp target teams map(alloc: density[:density_buffer.N()],energy[:energy_buffer.N()],pressure[:field.pressure.N()],soundspeed[:field.soundspeed.N()]) firstprivate(y_min,y_max,x_min,x_max,base_stride)
