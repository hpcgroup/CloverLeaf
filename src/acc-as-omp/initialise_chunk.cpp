...
#pragma omp target teams map(alloc: vertexx[:field.vertexx.N()],vertexdx[:field.vertexdx.N()]) firstprivate(xrange,xmin,dx,x_min)
...
#pragma omp target teams map(alloc: vertexy[:field.vertexy.N()],vertexdy[:field.vertexdy.N()]) firstprivate(yrange,ymin,dy,y_min)
#pragma omp distribute parallel for simd
...
#pragma omp target teams map(alloc: cellx[:field.cellx.N()],celldx[:field.celldx.N()],vertexx[:field.vertexx.N()]) firstprivate(xrange1,dx)
#pragma omp distribute parallel for simd
...
#pragma omp target teams map(alloc: celly[:field.celly.N()],celldy[:field.celldy.N()],vertexy[:field.vertexy.N()]) firstprivate(yrange1,dy)
#pragma omp distribute parallel for simd
...
#pragma omp target teams map(alloc: volume[:field.volume.N()],xarea[:field.xarea.N()],yarea[:field.yarea.N()],celldx[:field.celldx.N()],celldy[:field.celldy.N()]) firstprivate(yrange1,xrange1,base_stride,dx,dy,flux_x_stride,flux_y_stride)
#pragma omp distribute parallel for simd
