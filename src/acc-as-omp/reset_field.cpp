...
#pragma omp target teams map(alloc: density0[:field.density0.N()],density1[:field.density1.N()],energy0[:field.energy0.N()],energy1[:field.energy1.N()]) firstprivate(y_min,y_max,x_min,x_max,base_stride)
...
#pragma omp target teams map(alloc: xvel0[:field.xvel0.N()],xvel1[:field.xvel1.N()],yvel0[:field.yvel0.N()],yvel1[:field.yvel1.N()]) firstprivate(y_min,y_max,x_min,x_max,vels_wk_stride)
#pragma omp distribute parallel for simd collapse(2)
