...
#pragma omp target teams map(alloc: celldx[:field.celldx.N()],celldy[:field.celldy.N()],density0[:field.density0.N()],pressure[:field.pressure.N()],viscosity[:field.viscosity.N()],xvel0[:field.xvel0.N()],yvel0[:field.yvel0.N()]) firstprivate(y_min,y_max,x_min,x_max,vels_wk_stride,base_stride)
