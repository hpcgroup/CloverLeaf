...
void generate_chunk(const int tile, global_variables &globals) {
  ...
  std::vector<double, umpire::TypedAllocator<double>> state_xvel_vec(globals.config.number_of_states, double_vector_allocator);
  std::vector<double, umpire::TypedAllocator<double>> state_yvel_vec(globals.config.number_of_states, double_vector_allocator);
  std::vector<double, umpire::TypedAllocator<double>> state_xmin_vec(globals.config.number_of_states, double_vector_allocator);
  std::vector<double, umpire::TypedAllocator<double>> state_xmax_vec(globals.config.number_of_states, double_vector_allocator);
  std::vector<double, umpire::TypedAllocator<double>> state_ymin_vec(globals.config.number_of_states, double_vector_allocator);
  std::vector<double, umpire::TypedAllocator<double>> state_ymax_vec(globals.config.number_of_states, double_vector_allocator);
  std::vector<double, umpire::TypedAllocator<double>> state_radius_vec(globals.config.number_of_states, double_vector_allocator);
  std::vector<int,umpire::TypedAllocator<int>> state_geometry_vec(globals.config.number_of_states, int_vector_allocator);
