...
register_flag_required(OFFLOAD_ARCH "Specify the architecture to set as a back end")
register_flag_required(SYCL_TARGET "Specify the architecture to set as a back end")
...
macro(setup)
    ...
    elseif (${SYCL_COMPILER} STREQUAL "DPCPP")
        ...
        register_append_cxx_flags(ANY -fsycl -fsycl-targets=${SYCL_TARGET} -Xsycl-target-backend --offload-arch=${OFFLOAD_ARCH})
        register_append_link_flags(-fsycl  -fsycl-targets=${SYCL_TARGET} -Xsycl-target-backend --offload-arch=${OFFLOAD_ARCH})
