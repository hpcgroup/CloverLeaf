...
macro(setup)
    ...
    elseif (${SYCL_COMPILER} STREQUAL "DPCPP")
        ...
        register_append_cxx_flags(ANY -fsycl -fsycl-targets=amdgcn-amd-amdhsa -Xsycl-target-backend --offload-arch=gfx906)
        register_append_link_flags(-fsycl  -fsycl-targets=amdgcn-amd-amdhsa -Xsycl-target-backend --offload-arch=gfx906)
    ...
    elseif (${SYCL_COMPILER} STREQUAL "ONEAPI-Clang")
        ...
        register_append_cxx_flags(ANY -fsycl-targets=-fsycl -fsycl-targets=amdgcn-amd-amdhsa --offload-arch=gfx906 -Xsycl-target-backend=amdgcn-amd-amdhsa --offload-arch=gfx906)
        register_append_link_flags(-fsycl-targets=-fsycl -fsycl-targets=amdgcn-amd-amdhsa --offload-arch=gfx906 -Xsycl-target-backend=amdgcn-amd-amdhsa --offload-arch=gfx906)
    else ()
